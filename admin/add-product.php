...
<div class="admin-wrapper">
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-dark m-0">Add New Product</h2>
        ...
        <div class="card-custom">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="e.g., Hand Blender 300W" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="price" class="form-control" placeholder="e.g., 1250.00" required>
                </div>
